...
public class RequestParamController {
    ...
    public String requestParamRequired(@RequestParam(required = true) String username,
                                 @RequestParam(required = false) Integer age) throws IOException { // int에는 null 들어갈 수 없음
        log.info("username={}, age={}", username, age);
        return "ok";
    }
    ...
    public String requestParamMap(@RequestParam Map<String, Object> paramMap) throws IOException { // 동일 파라미터명의 값이 두 개 이상인 경우 MultiValueMap 사용
